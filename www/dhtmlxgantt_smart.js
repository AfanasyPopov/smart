...
! function (t) {
  ...
  function i(t) {
    ...
    t.attachEvent = function (t, i, n) {
      return t = "ev_" + t.toLowerCase(), e[t] || (e[t] = new r(n || this)), t + ":" + e[t].addEvent(i)
    ...
    s = function () {
      ...
      function t(t, e, i, s) {
        t && (this.$container = a.toNode(t), this.$parent = t), this.$config = n.mixin(e, {
          headerHeight: 33
        }), this.$gantt = s, this.$id = e.id || "c" + n.uid(), this.$name = "cell", this.$factory = i, r(this)
      }
      return t.prototype.destructor = function () {
        this.$parent = this.$container = this.$view = null, this.callEvent("onDestroy", []), this.detachAllEvents()
        ...
        var t = this;
        this.$gantt.$services.getService("mouseEvents").delegate("click", "gantt_header_arrow", function (e) {
        ...
        "gantt_layout_content" == t.className && (t.style.height = this.$lastSize.contentY + "px")
    ...
    s = function (t) {
      ...
      return n(e, t), e.prototype.destructor = function () {
        ...
        if (this.$root && !this._resizeInProgress && (this.callEvent("onBeforeResize", []), i = !0, this._resizeInProgress = !0), t.prototype.resize.call(this, !0), t.prototype.resize.call(this, !1), i) {
          ...
          for (var r = 0; r < n.length; r++) n[r].$config.hidden || n[r].setContentSize();
          var a = !1;
          if (this.$config.autosize) a = !0, this.autosize(this.$config.autosize);
          else
            for (var r = 0; r < n.length; r++) n[r].$content && "scroller" == n[r].$content.$name && (n[r].$content.shouldHide() ? (n[r].hide(), a = !0) : n[r].$content.shouldShow() && (n[r].show(), a = !0));
          if (a) {
            this.resize();
            for (var r = 0; r < n.length; r++) n[r].$config.hidden || n[r].setContentSize()
          }
        ...
        var i = [];
        if (t === this.$name && i.push(this), this.$cells)
        ...
        for (var t, e, i, n = 0, r = 0, a = 0; a < this.$cells.length; a++) e = this.$cells[a], e.$config.hidden || (t = e.getContentSize(), "scrollbar" === e.$config.view && (t.height = 0, t.width = 0), e.$config.resizer && (this._xLayout ? t.height = 0 : t.width = 0), i = e._getBorderSizes(), this._xLayout ? (n += t.width + i.horizontal, r = Math.max(r, t.height + i.vertical)) : (n = Math.max(n, t.width + i.horizontal), r += t.height + i.vertical));
        return i = this._getBorderSizes(), n += i.horizontal, r += i.vertical, this.$root && (n += 1, r += 1), {
          width: n,
          height: r
        }
        ...
        "xy" === t ? e.x = e.y = !0 : "y" === t || !0 === t ? e.y = !0 : "x" === t && (e.x = !0);
        var i = this._getBoxStyles(this.$container),
  ...
  function i(t, e) {
    if (!e) return !0;
    var i = 1e3 / e;
    return i < 1 || !t._on_timeout && (setTimeout(function () {
  ...
  var n = i(0),
    r = function (t) {
      function e(t) {
        return t.view ? r.call(this, "viewcell", null, t) : t.resizer ? r.call(this, "resizer", null, t) : t.rows || t.cols ? r.call(this, "layout", null, t) : t.views ? r.call(this, "multiview", null, t) : r.call(this, "cell", null, t)
      }

      function r(e, i, r) {
        var a = l[e];
        if (!a || !a.create) return !1;
        var r = n.copy(r);
        r.id && !r.css && (r.css = r.id + "_cell");
        var s = new a.create(i, r, this, t);
        return a.configure && a.configure(s), s.$id || (s.$id = r.id || t.uid()), s.$parent || "object" != typeof i || (s.$parent = i), s.$config || (s.$config = r), d[s.$id] && (s.$id = t.uid()), d[s.$id] = s, s
      }
  ...
  var n = i(5),
    ...
    s = function (t) {
      ...
      function e(e, i, n) {
        ...
        return !(i.view && (i.id && (this.$id = r.uid()), this.$content = this.$factory.createView(i.view, this, i), !this.$content)) && (a.$name = "viewCell", a)
      }
      return n(e, t), e.prototype.destructor = function () {
  ...
  function n(t) {
    ...
    return {
      ...
      prepareConfigs: function (t, e, i, n, r, a) {
        for (var s = this.splitSize(n, t.length), o = i, l = [], d = t.length - 1; d >= 0; d--) {
          var c = d == t.length - 1,
            h = this.initScaleConfig(t[d], r, a);
          c && this.processIgnores(h), this.initColSizes(h, e, o, s[d]), this.limitVisibleRange(h), c && (o = h.full_width), l.unshift(h)
        }
        for (var d = 0; d < l.length - 1; d++) this.alineScaleColumns(l[l.length - 1], l[d]);
        for (var d = 0; d < l.length; d++) this.setPosSettings(l[d]);
        return l
      },
  ...
  var n = i(0),
    r = function () {
      return {
        $getConfig: function () {
          var t = this.$config.config,
            e = this.$gantt.config;
          return t ? n.mixin(t, e) : e
        }
      }
    };
  ...
  s.prototype = {
    _parseInner: function (t) {
      for (var e = null, i = [], n = 0, r = t.length; n < r; n++) e = t[n], this.$initItem && (e = this.$initItem(e)), this.callEvent("onItemLoading", [e]) && (this.pull[e.id] = e, this.fullOrder.push(e.id), i.push(e));
      return i
    },
    parse: function (t) {
    ...
    updateItem: function (t, e) {
      if (r.defined(e) || (e = this.getItem(t)), !this._skip_refresh && !1 === this.callEvent("onBeforeUpdate", [t, e])) return !1;
      this.pull[t] = e, this._skip_refresh || (this.callEvent("onAfterUpdate", [t, e]), this.callEvent("onStoreUpdated", [t, e, "update"]))
    },
    ...
    removeItem: function (t) {
      ...
      if (!this._skip_refresh && !1 === this.callEvent("onBeforeDelete", [t, e])) return !1;
      this._removeItemInner(t), this._skip_refresh || (this.filter(), this.callEvent("onAfterDelete", [t, e]), this.callEvent("onStoreUpdated", [t, e, "delete"]))
    },
    ...
    addItem: function (t, e) {
      ...
      var i = t.id;
      return this.$initItem && (t = this.$initItem(t)), !(!this._skip_refresh && !1 === this.callEvent("onBeforeAdd", [i, t])) && (this._addItemInner(t, e), this._skip_refresh || (this.callEvent("onAfterAdd", [i, t]), this.callEvent("onStoreUpdated", [i, t, "add"])), i)
    },
    ...
    move: function (t, e) {
      var i = this.getIdByIndex(t),
        n = this.getItem(i);
      this._moveInner(t, e), this._skip_refresh || this.callEvent("onStoreUpdated", [i, n, "move"])
    },
    clearAll: function () {
    ...
    refresh: function (t) {
      if (!this._skip_refresh) {
        if (t) {
          ...
          this.filter(), this.arraysEqual(e, this.visibleOrder) || (t = void 0)
        } else this.filter();
    ...
    getItems: function () {
      for (var t = [], e = 0; e < this.fullOrder.length; e++) t.push(this.pull[this.fullOrder[e]]);
      return t
    },
    ...
    getNext: function (t) {
      return this.visibleOrder[this.getIndexById(t) + 1]
    },
    getPrev: function (t) {
      return this.visibleOrder[this.getIndexById(t) - 1]
    }
  ...
  function s(t) {
    ...
    if (t.config.scale_offset_minimal) {
      var i = new d(t),
        n = [i.primaryScale()].concat(t.config.subscales);
      i.sortScales(n), e = n[n.length - 1].unit
    }
    return e
  }
  ...
  function o(t) {
    var e = s(t),
      i = a(e, t);
    i.start_date && i.end_date || (i = n(t), i.start_date && i.end_date || (i = r(t)), i.start_date = t.date[e + "_start"](i.start_date), i.start_date = t.calculateEndDate({
      start_date: t.date[e + "_start"](i.start_date),
      duration: -1,
      unit: e
    }), i.end_date = t.date[e + "_start"](i.end_date), i.end_date = t.calculateEndDate({
      start_date: i.end_date,
      duration: 2,
      unit: e
    })), t._min_date = i.start_date, t._max_date = i.end_date
  }
  ...
  window.gantt = i(21)(), i(96)(window.gantt)
}, function (t, e, i) {
  t.exports = function () {
    var t = {
      version: "5.0.5",
    ...
    i(22)(t), t.$services = t.$inject(i(23)), t.config = t.$inject(i(24)), t.ajax = i(25)(t), t.date = i(26)(t);
    var e = i(27)(t);
    ...
    var r = i(29),
      a = new r;
    a.registerProvider("global", function () {
      return {
        min_date: t._min_date,
        max_date: t._max_date,
        selected_task: t._selected_task
      }
    }), t.getState = a.getState, t.$services.setService("state", function () {
      return a
    });
    var s = i(0);
    s.mixin(t, s), t.env = i(6), s.mixin(t, i(30)(t));
    var o = i(31).init(t);
    return t.$ui = o.factory, t.$ui.layers = o.render, t.$mouseEvents = o.mouseEvents, t.$services.setService("mouseEvents", function () {
      return t.$mouseEvents
    }), t.mixin(t, o.layersApi), i(51)(t), t.$services.setService("layers", function () {
      return o.layersService
    }), i(52)(t), i(58)(t), i(61)(t), i(67)(t), i(68)(t), i(69)(t), i(70)(t), i(71)(t), i(72)(t), i(79)(t), i(80)(t), i(81)(t), i(82)(t), i(83)(t), i(84)(t), i(85)(t), i(86)(t), i(87)(t), i(88)(t), i(89)(t), i(90)(t), i(91)(t), i(92)(t), i(93)(t), i(94)(t), t
  }
}, function (t, e) {
  t.exports = function (t) {
    t.$inject = function (t) {
  ...
  t.exports = function (t) {
    function e(e, i) {
      this._obj = e, i && (this._settings = i), n(this);
      ...
      for (var s = 0; s < a.length; s++) r.bind(function (n) {
        r.event(e, n.down, r.bind(function (a) {
          n.accessor(a) && (i.original_target = {
            target: a.target || a.srcElement
          }, t.config.touch ? (this.clearDragTimer(), this._drag_start_timer = setTimeout(r.bind(function () {
            this.dragStart(e, a, n)
          }, this), t.config.touch_drag)) : this.dragStart(e, a, n))
        }, this)), r.event(document.body, n.up, r.bind(function (t) {
    ...
    return e.prototype = {
      traceDragEvents: function (t, e) {
        var i = r.bind(function (i) {
            return this.dragMove(t, i, e.accessor)
          }, this),
          n = (r.bind(function (e) {
            return this.dragScroll(t, e)
          }, this), r.bind(function (t) {
            return t && t.preventDefault && t.preventDefault(), (t || event).cancelBubble = !0, !(!r.defined(this.config.updates_per_second) || a(this, this.config.updates_per_second)) || i(t)
          }, this)),
          s = r.bind(function (i) {
            return r.eventRemove(document.body, e.move, n), r.eventRemove(document.body, e.up, s), this.dragEnd(t)
          }, this);
        r.event(document.body, e.move, n), r.event(document.body, e.up, s)
      },
      ...
      backupEventTarget: function (e, i) {
        if (t.config.touch) {
          ...
          this.config.original_target = {
            target: a
          }, this.config.backup_element = r, r.parentNode.appendChild(a), r.style.display = "none", document.body.appendChild(r)
        }
      },
  ...
  var n = i(0),
    r = function () {
      function t() {
        var t = {};
        for (var e in r) n.mixin(t, r[e](), !0);
        return t
      }
  ...
  t.exports = function (t) {
    ...
    function s(e, i, n) {
      return "<div " + t._waiAria.messageButtonAttrString(e) + " class='gantt_popup_button dhtmlx_popup_button gantt_" + i.toLowerCase().replace(/ /g, "_") + "_button dhtmlx_" + i.toLowerCase().replace(/ /g, "_") + "_button' result='" + n + "' ><div>" + e + "</div></div>"
    }
    ...
    var p = null;
    document.attachEvent ? document.attachEvent("onkeydown", r) : document.addEventListener("keydown", r, !0);
    var v = function () {
    ...
    return b.seed = (new Date).valueOf(), b.uid = n.uid, b.expire = 4e3, b.keyboard = !0, b.position = "top", b.pull = {}, b.timers = {}, b.hideAll = function () {
  ...
  function n(t) {
    ...
    i.registerView("cell", o), i.registerView("resizer", h), i.registerView("scrollbar", u), i.registerView("layout", l, function (t) {
      "main" === (t.$config ? t.$config.id : null) && e(t, b)
    }), i.registerView("viewcell", c), i.registerView("multiview", d), i.registerView("timeline", _, function (t) {
      "timeline" !== (t.$config ? t.$config.id : null) && "task" != t.$config.bind || e(t, y)
    }), i.registerView("grid", g, function (t) {
      "grid" !== (t.$config ? t.$config.id : null) && "task" != t.$config.bind || e(t, k)
    });
    var n = s(t);
    return {
      factory: i,
    ...
    r = function (t) {
      return function (e) {
        ...
        function n(t, e, i, n) {
          var r = h[t][e];
          if (r)
            for (var a = 0; a < r.length; a++) i && i == r[a].root != i || r[a].handler.apply(this, n)
        }
        ...
        function r(t) {
          ...
          var i = t.target || t.srcElement,
            n = e.locate(t),
            r = !0;
          null !== n ? r = !e.checkEvent("onTaskClick") || e.callEvent("onTaskClick", [n, t]) : e.callEvent("onEmptyClick", [t]);
          var a = h.click;
          if (r) {
            if (!s(t, i, a, n)) return;
            n && e.getTask(n) && e.config.select_task && e.selectTask(n)
          }
        }
          ...
          for (var s = !0; n;) {
            ...
            if (o) {
              ...
              for (var l = 0; l < o.length; l++)
                if (o[l] && r[o[l]])
                  for (var d = r[o[l]], c = 0; c < d.length; c++)
                    if (!d[c].root || t.isChildOf(n, d[c].root)) {
                      var h = d[c].handler.call(e, i, a, n);
                      s = s && !(void 0 !== h && !0 !== h)
                    }
            }
            n = n.parentNode
        ...
        function o(t) {
          ...
          var i = t.target || t.srcElement,
            n = e.locate(t),
            r = !e.checkEvent("onTaskDblClick") || e.callEvent("onTaskDblClick", [n, t]);
          if (r) {
            if (!s(t, i, h.doubleclick, n)) return;
            null !== n && e.getTask(n) && r && e.config.details_on_dblclick && e.showLightbox(n)
          }
        }
        ...
        function d(t, e, i, n) {
          if (h[t])
            for (var r = 0; r < h[t].length; r++) h[t][r].root == n && (h[t].splice(r, 1), r--)
        }

        function c(t) {
          for (var i = 0; i < u.length; i++) e.eventRemove(u[i][0], u[i][1], u[i][2]);
          if (u = [], t) {
            u.push([t, "click", r]), u.push([t, "dblclick", o]), u.push([t, "mousemove", l]), u.push([t, "contextmenu", a]);
            for (var i = 0; i < u.length; i++) e.event(u[i][0], u[i][1], u[i][2])
          }
        }
        var h = {
            click: {},
      ...
      return {
        ...
        createDataRender: function (i) {
          var n = i.name,
            ...
            s = e.createGroup(r, a, function (t) {
              if (!s.filters) return !0;
              for (var e = 0; e < s.filters.length; e++)
                if (!1 === s.filters[e](t)) return !1
            });
      ...
      return {
        createGroup: function (t, i, r) {
          return {
            ...
            _add: function (t) {
              if (t && (t.id = t.id || a.uid(), this.tempCollection.push(t)), this.container())
                for (var n = this.container(), r = this.tempCollection, s = 0; s < r.length; s++) {
                  t = r[s];
                  var o = t.container,
                    l = t.id,
                    d = t.topmost;
                  if (!o.parentNode)
                    if (d) n.appendChild(o);
                    else {
                      var c = i ? i() : n.firstChild;
                      c ? n.insertBefore(o, c) : n.appendChild(o)
                    }
                  this.renderers[l] = e.getRenderer(l, t, o), this.tempCollection.splice(s, 1), s--
                }
            },
            addLayer: function (t) {
              return t && ("function" == typeof t && (t = {
                renderer: t
              }), void 0 === t.filter ? t.filter = n(r || []) : t.filter instanceof Array && (t.filter.push(r), t.filter = n(t.filter)), t.container || (t.container = document.createElement("div"))), this._add(t), t ? t.id : void 0
            },
  ...
  var n = i(5),
    ...
    l = function (t) {
      ...
      function e(e, i, n, r) {
        ...
        return this._isHorizontal() ? (s.$config.height = o, s.$parent.$config.height = o) : (s.$config.width = o, s.$parent.$config.width = o), this.$config.scrollPosition = 0, s.$name = "scroller", s
      }
      ...
      return n(e, t), e.prototype.init = function (t) {
        ...
        this.$scroll_hor = this.$view, a.event(this.$view, "scroll", this._scrollHorizontalHandler)
        ...
        this.$scroll_ver = this.$view, a.event(this.$view, "scroll", this._scrollVerticalHandler)
      }, e.prototype._updateLinkedViews = function () {
        this._getRootParent()
      }, e.prototype._initMouseWheel = function () {
        s.isFF ? a.event(this._getRootParent().$view, "wheel", this._mouseWheelHandler) : a.event(this._getRootParent().$view, "mousewheel", this._mouseWheelHandler)
        ...
        for (var t, e = 0, i = 0, n = this._getLinkedViews(), r = this._isHorizontal() ? "scrollWidth" : "scrollHeight", a = this._isHorizontal() ? "contentX" : "contentY", s = this._isHorizontal() ? "x" : "y", o = this._getScrollOffset(), l = 0; l < n.length; l++)
          if ((t = n[l]) && t.$content && t.$content.getSize) {
            var d, c = t.$content.getSize();
            d = c.hasOwnProperty(r) ? c[r] : c[a], c[a] > c[s] && c[a] > e && d > c[s] - o + 2 && (e = d, i = c[s])
          }
        return {
          outerScroll: i,
          innerScroll: e
        ...
        n.innerScroll && e > n.outerScroll && (n.innerScroll += e - n.outerScroll), this.$config.scrollSize = n.innerScroll, this.$config.width = e, this.$config.height = i, this._setScrollSize(n.innerScroll)
        ...
        var t = 0;
        if (this._isVertical()) {
          for (var e = null, i = this.$parent.$parent.getCells(), n = 0; n < i.length; n++) this.$parent === i[n] && (e = i[n - 1]);
          !e || "timeline" != e.$config.view && "grid" != e.$config.view || (t = e.$content.$getConfig().scale_height)
        } else
          for (var r = this._getLinkedViews(), n = 0; n < r.length; n++) {
            var a = r[n],
              s = a.$parent,
              i = s.$cells,
              o = i[i.length - 1];
  ...
  var r = i(13),
    ...
    l = i(38),
    d = function (t, e, i, n) {
      this.$config = o.mixin({}, e || {}), this.$scaleHelper = new r(n), this.$gantt = n, s(this), a(this)
    };
  d.prototype = {
    init: function (t) {
    ...
    setSize: function (t, e) {
      ...
      if (this.refresh(), this.$task_bg.style.backgroundImage = "", i.smart_rendering) {
        var r = this.$gantt.getDatastore(this.$config.bind);
    ...
    getSize: function () {
      var t = this.$getConfig(),
        e = this.$gantt.getDatastore(this.$config.bind),
    ...
    _attachLayers: function (t) {
      ...
      if (this.$config.bind) {
        ...
        this.$gantt.attachEvent("onDataRender", function () {
          if (e.isVisible()) {
            var t = e.$getConfig();
            if (t.static_background) {
              var i = e.$gantt.getDatastore(e.$config.bind);
              d.render(e.$task_bg, t, e.getScale(), t.row_height * i.countVisible())
            }
          }
        })
      }
      if (this.$config.bindLinks) {
        var c = i.getDataRender(this.$config.bindLinks);
        c || (c = i.createDataRender({
          name: this.$config.bindLinks,
          defaultContainer: function () {
            return e.$task_data
          }
        }));
        for (var h = this.$config.linkLayers, a = 0; h && a < h.length; a++) {
          var s = h[a];
          s.host = this;
          var u = c.addLayer(s);
          this._taskLayers.push(u), h[a].expose && (this._linkRenderer = c.getLayer(u))
        }
      }
    },
    ...
    _render_tasks_scales: function () {
      ...
      if (this.isVisible()) {
        ...
        var l = a.prepareConfigs(s, t.min_column_width, o, n - 1, r.min_date, r.max_date),
    ...
    columnIndexByDate: function (t) {
      var e = new Date(t).valueOf(),
        i = this._tasks.trace_x,
        r = this._tasks.ignore_x,
        a = this.$gantt.getState();
      if (e <= a.min_date) return 0;
      if (e >= a.max_date) return i.length;
      for (var s = n(i, e), o = +this._tasks.trace_x[s]; r[o];) o = this._tasks.trace_x[++s];
      return o ? s + (t - i[s]) / this._getColumnDuration(this._tasks, i[s]) : 0
    },
    getItemPosition: function (t, e, i) {
      var n = this.posFromDate(e || t.start_date),
        r = this.posFromDate(i || t.end_date);
      return r = Math.max(n, r), {
        left: n,
        top: this.getItemTop(t.id),
        height: this.$gantt.getTaskHeight(),
        width: Math.max(r - n, 0)
      }
    },
    ...
    getItemTop: function (t) {
      if (this.$config.bind) {
        ...
        return e ? e.getIndexById(t) * this.$gantt.config.row_height : 0
      }
      return 0
    },
    getScale: function () {
    ...
    destroy: function () {
      var t = this.$gantt;
      this._clearLayers(t), this.$task = null, this.$task_scale = null, this.$task_data = null, this.$task_bg = null, this.$task_links = null, this.$task_bars = null, this.$gantt = null
    }
  }, t.exports = d
}, function (t, e) {
  var i = function () {
  ...
  var n = (i(1), i(0)),
    ...
    s = i(14),
    o = function (t, e, i, a) {
      this.$config = n.mixin({}, e || {}), this.$gantt = a, this.$parent = t, s(this), r(this), this.$state = {}
    };
  o.prototype = {
    init: function (t) {
      var e = this.$gantt,
        i = e._waiAria.gridAttrString(),
        n = e._waiAria.gridDataAttrString();
      t.innerHTML = "<div class='gantt_grid' style='height:inherit;width:inherit;' " + i + "></div>", this.$grid = t.childNodes[0], this.$grid.innerHTML = "<div class='gantt_grid_scale' " + e._waiAria.gridScaleRowAttrString() + "></div><div class='gantt_grid_data' " + n + "></div>", this.$grid_scale = this.$grid.childNodes[0], this.$grid_data = this.$grid.childNodes[1];
      var r = this.$getConfig()[this.$config.bind + "_attribute"];
      !r && this.$config.bind && (r = this.$config.bind + "_id"), this.$config.item_attribute = r || null;
      var s = this._createLayerConfig();
      this.$config.layers || (this.$config.layers = s);
      var o = a(this.$gantt, this);
      o.init(), this._renderHeaderResizers = o.doOnRender, this._addLayers(this.$gantt), this.callEvent("onReady", [])
    },
    setSize: function (t, e) {
      this.$config.width = t + 1, this.$state.width = t, this.$state.height = e;
      var i = this._setColumnsWidth(this.$config.width);
      this.$config.width -= 1;
      var n = this.$getConfig();
      i !== t && (n.grid_width = i, this.$config.width = i - 1);
      var r = Math.max(this.$state.height - n.scale_height, 0);
      this.$grid_data.style.height = r + "px", this.refresh()
    },
    getSize: function () {
      var t = this.$getConfig(),
        e = this.$gantt.getDatastore(this.$config.bind),
    ...
    refresh: function () {
      this._calculateGridWidth(), this._renderGridHeader()
    },
    scrollTo: function (t, e) {
      if (this.isVisible()) {
        1 * t == t && (this.$grid.scrollLeft = t, this.$state.scrollLeft = this.$grid.scrollLeft);
        var i = this.$getConfig();
        1 * e == e ? (this.$grid_data.scrollTop = e, this.$state.scrollTop = this.$grid_data.scrollTop, i.smart_rendering && this.$grid_data.scrollTop !== e && (this.$grid_data.scrollTop = e % i.row_height, this.$state.scrollTop = this.$grid_data.scrollTop)) : i.smart_rendering && this.$grid_data.scrollTop !== this.$state.scrollTop && (this.$grid_data.scrollTop = this.$state.scrollTop % i.row_height)
      }
    },
    ...
    _setColumnsWidth: function (t) {
      for (var e = (this.$getConfig(), this.getGridColumns()), i = 0, n = t, r = 0, a = e.length; r < a; r++) i += 1 * e[r].width;
      isNaN(i) && this._calculateGridWidth(), i = 0;
      for (var r = 0, a = e.length; r < a; r++) i += 1 * e[r].width;
      for (var s = e.length, o = n - i, l = 0, r = 0; r < s; r++) {
        var d = Math.floor(o * (e[r].width / i));
        i -= e[r].width, l = e[r].width + d, (e[r].min_width && l >= e[r].min_width || !e[r].min_width || l > e[r].width) && (o -= d, e[r].width = l)
      }
      for (var c = o > 0 ? 1 : -1; o > 0 && 1 === c || o < 0 && -1 === c;) {
        var h = o;
        for (r = 0; r < s; r++) {
          var t = e[r].width + c;
          if ((e[r].min_width && t >= e[r].min_width || !e[r].min_width || l > e[r].width) && (o -= c, e[r].width = t, !o)) break
        }
        if (h == o) break
      }
      return n
    ...
    _calculateGridWidth: function () {
      for (var t = this.$getConfig(), e = this.getGridColumns(), i = 0, n = [], r = [], a = 0; a < e.length; a++) {
        ...
        window.isNaN(s) && (s = 50, n.push(a)), r[a] = s, i += s
      }
      var o = this._getGridWidth();
      if (t.autofit || n.length) {
        var l = o - i;
        n.length > 0 ? n.length : r.length > 0 && r.length;
        if (n.length > 0)
          for (var d = l / (n.length ? n.length : 1), a = 0; a < n.length; a++) {
            var c = n[a];
            r[c] += d
          } else
            for (var d = l / (r.length ? r.length : 1), a = 0; a < r.length; a++) r[a] += d;
    ...
    _renderGridHeader: function () {
      for (var t = this.$gantt, e = this.$getConfig(), i = this.$gantt.locale, n = this.$gantt.templates, r = this.getGridColumns(), a = [], s = 0, o = i.labels, l = e.scale_height - 1, d = 0; d < r.length; d++) {
        var c = d == r.length - 1,
          h = r[d];
        h.name || (h.name = t.uid() + "");
        var u = 1 * h.width,
      ...
      this.$grid_scale.style.height = e.scale_height + "px", this.$grid_scale.style.lineHeight = l + "px", this.$grid_scale.style.width = "inherit", this.$grid_scale.innerHTML = a.join(""), this._renderHeaderResizers && this._renderHeaderResizers()
    },
    _getGridWidth: function () {
      return this.$config.width
    },
    destroy: function () {
      this._clearLayers(this.$gantt), this.$grid = null, this.$grid_scale = null, this.$grid_data = null, this.$gantt = null, this.callEvent("onDestroy", []), this.detachAllEvents()
    }
  }, t.exports = o
}, function (t, e) {
  function i(t, e) {
  ...
  function i(t) {
    function e(e, n) {
      var r = n.$getConfig(),
        ...
        o = i;
      return s || (s = o), s.call(t, e, n, t.bind(o, t))
    }
    ...
    function i(e, i) {
      if (!t._isAllowedUnscheduledTask(e)) {
        var n = i.getItemPosition(e),
          ...
          _ = Math.floor((t.config.row_height - d) / 2);
        u == s.types.milestone && s.link_line_width > 1 && (_ += 1), u == s.types.milestone && (n.left -= Math.round(d / 2), n.width = d);
        var g = document.createElement("div"),
          f = Math.round(n.width);
        i.$config.item_attribute && g.setAttribute(i.$config.item_attribute, e.id), s.show_progress && u != s.types.milestone && l(e, g, f);
        var p = o(e, f);
        e.textColor && (p.style.color = e.textColor), g.appendChild(p);
        var v = c("gantt_task_line", t.templates.task_class(e.start_date, e.end_date, e), e.id, i);
        (e.color || e.progressColor || e.textColor) && (v += " gantt_task_inline_color"), g.className = v;
        var m = ["left:" + n.left + "px", "top:" + (_ + n.top) + "px", "height:" + d + "px", "line-height:" + Math.max(d < 30 ? d - 2 : d, 0) + "px", "width:" + f + "px"];
        e.color && m.push("background-color:" + e.color), e.textColor && m.push("color:" + e.textColor), g.style.cssText = m.join(";");
        var k = r(e);
        k && g.appendChild(k), k = a(e), k && g.appendChild(k), t._waiAria.setTaskBarAttr(e, g);
        var y = t.getState();
        return t.isReadonly(e) || (s.drag_resize && !t.isSummaryTask(e) && u != s.types.milestone && h(g, "gantt_task_drag", e, function (t) {
          var e = document.createElement("div");
          return e.className = t, e
        }), s.drag_links && s.show_links && h(g, "gantt_link_control", e, function (t) {
          var e = document.createElement("div");
          e.className = t, e.style.cssText = ["height:" + d + "px", "line-height:" + d + "px"].join(";");
          var i = document.createElement("div");
          i.className = "gantt_link_point";
          var n = !1;
          return y.link_source_id && s.touch && (n = !0), i.style.display = n ? "block" : "", e.appendChild(i), e
        })), g
      }
    }
    ...
    function r(e) {
      var i = "gantt_left " + s(!0, e);
      return n(e, t.templates.leftside_text, i)
    }

    function a(e) {
      var i = "gantt_right " + s(!1, e);
      return n(e, t.templates.rightside_text, i)
    }
    ...
    function o(e, i) {
      ...
      return t.getTaskType(e.type) != t.config.types.milestone && (n.innerHTML = t.templates.task_text(e.start_date, e.end_date, e)), n.className = "gantt_task_content", n
    }
    ...
    function l(e, i, n) {
      ...
      var a = document.createElement("div"),
        s = Math.round(n * r);
      s = Math.min(n, s), e.progressColor && (a.style.backgroundColor = e.progressColor, a.style.opacity = 1), a.style.width = s + "px", a.className = "gantt_task_progress", a.innerHTML = t.templates.progress_text(e.start_date, e.end_date, e);
      var o = document.createElement("div");
      if (o.className = "gantt_task_progress_wrapper", o.appendChild(a), i.appendChild(o), t.config.drag_progress && !t.isReadonly(e)) {
        var l = document.createElement("div");
        l.style.left = s + "px", l.className = "gantt_task_progress_drag", a.appendChild(l), i.appendChild(l)
      }
    }
    ...
    function h(e, i, n, r) {
      var a = t.getState(); + n.start_date >= +a.min_date && e.appendChild(r(i + " task_left")), +n.end_date <= +a.max_date && e.appendChild(r(i + " task_right"))
    }
    return e
  }
  t.exports = i
      ...
      if (n.show_task_cells)
        for (var o = 0; o < a; o++) {
          ...
          if (l > 0) {
            ...
            c.style.width = l + "px", d = "gantt_task_cell" + (o == a - 1 ? " gantt_last_cell" : ""), u = t.templates.task_cell_class(e, r.trace_x[o]), u && (d += " " + u), c.className = d, s.appendChild(c)
          }
        }
      var h = t.getGlobalTaskIndex(e.id) % 2 != 0,
        u = t.templates.task_row_class(e.start_date, e.end_date, e),
        _ = "gantt_task_row" + (h ? " odd" : "") + (u ? " " + u : "");
      return t.getState().selected_task == e.id && (_ += " gantt_selected"), s.className = _, n.smart_rendering && (s.style.position = "absolute", s.style.top = i.getItemPosition(e).top + "px", s.style.width = "100%"), s.style.height = n.row_height + "px", i.$config.item_attribute && s.setAttribute(i.$config.item_attribute, e.id), s
    }
    return e
  }
  t.exports = i
    ...
    var r = {
      ...
      a = {
        ...
        get_points: function (e, i) {
          ...
          var c = 2 * s.link_arrow_size,
            h = a.e_x > a.x;
          if (e.type == n.links.start_to_start) this.point_to(d.left, c), h ? (this.point_to(d.down, o), this.point_to(d.right, l)) : (this.point_to(d.right, l), this.point_to(d.down, o)), this.point_to(d.right, c);
          else if (e.type == n.links.finish_to_start)
            if (h = a.e_x > a.x + 2 * c, this.point_to(d.right, c), h) l -= c, this.point_to(d.down, o), this.point_to(d.right, l);
            else {
              l -= 2 * c;
              var u = o > 0 ? 1 : -1;
              this.point_to(d.down, u * (s.row_height / 2)), this.point_to(d.right, l), this.point_to(d.down, u * (Math.abs(o) - s.row_height / 2)), this.point_to(d.right, c)
            }
          else if (e.type == n.links.finish_to_finish) this.point_to(d.right, c), h ? (this.point_to(d.right, l), this.point_to(d.down, o)) : (this.point_to(d.down, o), this.point_to(d.right, l)), this.point_to(d.left, c);
          else if (e.type == n.links.start_to_finish)
            if (h = a.e_x > a.x - 2 * c, this.point_to(d.left, c), h) {
              l += 2 * c;
              var u = o > 0 ? 1 : -1;
              this.point_to(d.down, u * (s.row_height / 2)), this.point_to(d.right, l), this.point_to(d.down, u * (Math.abs(o) - s.row_height / 2)), this.point_to(d.left, c)
            } else l += c, this.point_to(d.down, o), this.point_to(d.right, l);
          return this.path
        },
        get_endpoint: function (e, i) {
          var r = i.$getConfig(),
            ...
            s = !1,
            o = !1;
          e.type == a.start_to_start ? s = o = !0 : e.type == a.finish_to_finish ? s = o = !1 : e.type == a.finish_to_start ? (s = !1, o = !0) : e.type == a.start_to_finish ? (s = !0, o = !1) : t.assert(!1, "Invalid link type");
          var l = t.getTask(e.source),
  ...
  function n(t) {
    function e(e, i) {
      for (var n, a = i.getGridColumns(), s = i.$getConfig(), o = [], l = 0; l < a.length; l++) {
        var d, c, h, u = l == a.length - 1,
          _ = a[l];
        if ("add" == _.name) {
          var g = t._waiAria.gridAddButtonAttrString(_);
          c = "<div " + g + " class='gantt_add'></div>", h = ""
        } else c = _.template ? _.template(e) : e[_.name], r.isDate(c) && (c = t.templates.date_grid(c, e)), h = c, c = "<div class='gantt_tree_content'>" + c + "</div>";
        var f = "gantt_cell" + (u ? " gantt_last_cell" : ""),
          p = "";
        if (_.tree) {
          for (var v = 0; v < e.$level; v++) p += t.templates.grid_indent(e);
          n = t._has_children(e.id), n ? (p += t.templates.grid_open(e), p += t.templates.grid_folder(e)) : (p += t.templates.grid_blank(e), p += t.templates.grid_file(e))
        }
        var m = "width:" + (_.width - (u ? 1 : 0)) + "px;";
        this.defined(_.align) && (m += "text-align:" + _.align + ";");
        var g = t._waiAria.gridCellAttrString(_, h);
        d = "<div class='" + f + "' style='" + m + "' " + g + ">" + p + c + "</div>", o.push(d)
      }
      var f = t.getGlobalTaskIndex(e.id) % 2 == 0 ? "" : " odd";
      if (f += e.$transparent ? " gantt_transparent" : "", f += e.$dataprocessor_class ? " " + e.$dataprocessor_class : "", t.templates.grid_row_class) {
        var k = t.templates.grid_row_class.call(t, e.start_date, e.end_date, e);
        k && (f += " " + k)
      }
      t.getState().selected_task == e.id && (f += " gantt_selected");
      var y = document.createElement("div");
      return y.className = "gantt_row" + f, y.style.height = s.row_height + "px", y.style.lineHeight = s.row_height + "px", i.$config.item_attribute && y.setAttribute(i.$config.item_attribute, e.id), t._waiAria.taskRowAttr(e, y), y.innerHTML = o.join(""), y
    }
    return e
  }
  var r = i(3);
      ...
      return function (t) {
        return {
          onCreated: function (t) {
            t.$config = n.mixin(t.$config, {
              bind: "task"
            }), "grid" == t.$config.id && this.extendGantt(t)
          },
          ...
          initEvents: function (t, e) {
            this._eventHandlers = [];
            var i = e.$services.getService("mouseEvents");
            this._eventHandlers.push(["click", "gantt_close", e.bind(function (t, e, i) {
              return this.close(e), !1
            }, e)]), this._eventHandlers.push(["click", "gantt_open", e.bind(function (t, e, i) {
              return this.open(e), !1
            }, e)]), this._eventHandlers.push(["click", "gantt_row", e.bind(function (i, n, r) {
              var a = t.$getConfig();
              if (null !== n) {
                var s = this.getTask(n);
                a.scroll_on_click && this.showDate(s.start_date), e.callEvent("onTaskRowClick", [n, r])
              }
            }, e)]), this._eventHandlers.push(["click", "gantt_grid_head_cell", e.bind(function (n, r, a) {
              var s = a.getAttribute("column_id");
              if (e.callEvent("onGridHeaderClick", [s, n])) {
                var o = t.$getConfig();
                if ("add" == s) return void i.callHandler("click", "gantt_add", void 0, [n, o.root_id]);
                if (o.sort) {
                  ...
                  if (l && void 0 !== l.sort && !0 !== l.sort && !(d = l.sort)) return;
                  var h = this._sort && this._sort.direction && this._sort.name == s ? this._sort.direction : "desc";
                  h = "desc" == h ? "asc" : "desc", this._sort = {
                    name: s,
                    direction: h
                  }, this.sort(d, "desc" == h)
                }
              }
            }, e)]), this._eventHandlers.push(["click", "gantt_add", e.bind(function (i, n, r) {
            ...
            for (var n = 0; n < this._eventHandlers.length; n++) {
              ...
              i.delegate(r[0], r[1], r[2], this.$grid)
            }
          },
          clearEvents: function (t, e) {
            for (var i = e.$services.getService("mouseEvents"), n = 0; n < this._eventHandlers.length; n++) {
              var r = this._eventHandlers[n];
              i.detach(r[0], r[1], r[2], t.$grid)
            }
            this._eventHandlers = []
          },
  ...
  function n(t, e) {
    ...
    if (e.$config.bind && t.getDatastore(e.$config.bind)) {
      ...
      t.defined(e.$getConfig().dnd_sensitivity) && (s.config.sensitivity = e.$getConfig().dnd_sensitivity), s.attachEvent("onBeforeDragStart", t.bind(function (r, a) {
        ...
        var a = i(r);
        s.config.marker.innerHTML = a.outerHTML, s.config.id = a.getAttribute(e.$config.item_attribute);
        var o = n(),
          l = o.getItem(s.config.id);
        s.config.index = o.getBranchIndex(s.config.id), s.config.parent = l.parent, l.$open = !1, l.$transparent = !0, this.refreshData()
        ...
        var i = r.getNodePosition(e.$grid_data),
          n = t.pageY - i.y + e.$state.scrollTop;
        return n < 0 && (n = 0), n
      }, t), s._getTaskByY = t.bind(function (t, i) {
        var r = e.$getConfig(),
          a = n();
        t = t || 0, r.smart_rendering && (t += e.$grid_data.scrollTop);
    ...
    o = function () {
      return function (t) {
        ...
        return {
          onCreated: function (t) {
            var e = t.$config;
            e.bind = n.defined(e.bind) ? e.bind : "task", e.bindLinks = n.defined(e.bindLinks) ? e.bindLinks : "link", t._linksDnD = a.createLinkDND(), t._tasksDnD = r.createTaskDND(), t._tasksDnD.extend(t), "timeline" == t.$config.id && this.extendGantt(t)
          },
          onInitialized: function (e) {
            this._attachDomEvents(t), this._attachGanttEvents(t), this._attachStateProvider(t, e), e._tasksDnD.init(e, t), e._linksDnD.init(e, t), "timeline" == e.$config.id && this.extendDom(e)
          },
          onDestroyed: function (e) {
            this._clearGanttEvents(t), this._clearDomEvents(t), this._clearStateProvider(t)
          },
          extendDom: function (e) {
          ...
          extendGantt: function (e) {
            t.dateFromPos = t.bind(e.dateFromPos, e), t.posFromDate = t.bind(e.posFromDate, e), t.getRowTop = t.bind(e.getRowTop, e), t.getTaskTop = t.bind(e.getItemTop, e), t.getTaskPosition = t.bind(e.getItemPosition, e), t.getTaskHeight = t.bind(e.getItemHeight, e), t.columnIndexByDate = t.bind(e.columnIndexByDate, e), t.roundTaskDates = t.bind(e.roundTaskDates, e), t.getScale = t.bind(e.getScale, e), t.getTaskNode = function (t) {
              return e._taskRenderer.rendered[t]
            }, t.getLinkNode = function (t) {
              return e._linkRenderer.rendered[t]
            }
          },
          _attachDomEvent: function (t, i, n) {
            this._events || (this._events = []);
            var r = e.getService("mouseEvents"),
              a = {
                event: t,
                className: i,
                handler: n,
            ...
            r.delegate(a.event, a.className, a.handler, a.root), this._events.push(a)
          },
          _clearDomEvents: function () {
            for (var t = e.getService("mouseEvents"), i = 0; i < this._events.length; i++) {
              var n = this._events[i];
              t.detach(n.event, n.className, n.handler, n.root)
            }
            this._events = []
          },
          _attachDomEvents: function (t) {
            ...
            this._attachDomEvent("click", "gantt_task_link", t.bind(function (t, e) {
              var i = this.locate(t, this.config.link_attribute);
              i && this.callEvent("onLinkClick", [i, t])
            }, t)), this._attachDomEvent("click", "gantt_scale_cell", t.bind(function (e, i) {
            ...
            }, t)), this._attachDomEvent("doubleclick", "gantt_task_link", t.bind(function (i, n, r) {
              var n = this.locate(i, t.config.link_attribute);
              e.call(this, n, i)
            }, t)), this._attachDomEvent("doubleclick", "gantt_link_point", t.bind(function (t, i, n) {
              var i = this.locate(t),
                r = this.getTask(i),
                a = null;
          ...
          _attachGanttEvents: function (t) {
            function e(t, e, i, n) {
              for (var r = 0; r < t.length; r++) t[r].change_id(e, i), t[r].render_item(n)
            }
            this._clearGanttEvents(t), this._onTaskIdChange = t.attachEvent("onTaskIdChange", function (i, n) {
              e(t._getTaskLayers(), i, n, t.getTask(n))
            }), this._onLinkIdChange && t.detachEvent(this._onLinkIdChange), this._onLinkIdChange = t.attachEvent("onLinkIdChange", function (i, n) {
              e(t._getLinkLayers(), i, n, t.getLink(n))
            })
          },
          _clearGanttEvents: function (t) {
            this._onTaskIdChange && t.detachEvent(this._onTaskIdChange), this._onLinkIdChange && t.detachEvent(this._onLinkIdChange)
          },
  ...
  function n(t, e) {
    ...
    return {
      ...
      set_actions: function () {
        var i = t.$task_data;
        e.event(i, "mousemove", e.bind(function (t) {
          this.on_mouse_move(t || event)
        }, this)), e.event(i, "mousedown", e.bind(function (t) {
          this.on_mouse_down(t || event)
        }, this)), e.event(i, "mouseup", e.bind(function (t) {
      ...
      _resize_progress: function (t, e, i) {
        var n = this._drag_task_coords(t, i),
          r = Math.max(0, i.pos.x - n.start);
        t.progress = Math.min(1, r / (n.end - n.start))
      },
      ...
      _update_on_move: function (t) {
        var i = this.drag;
        if (i.mode) {
          var n = a.getRelativeEventPosition(t, e.$task_data);
          if (i.pos && i.pos.x == n.x) return;
          i.pos = n;
          var r = e.dateFromPos(n.x);
          ...
          if (this._handlers[i.mode]) {
            var l = e.mixin({}, o),
              d = e.mixin({}, o);
            this._handlers[i.mode].apply(this, [d, s, i]), e.mixin(o, d, !0), e.callEvent("onTaskDrag", [o.id, i.mode, d, l, t]), e.mixin(o, d, !0), e._update_parents(i.id), e.refreshTask(i.id)
          }
        }
      },
      on_mouse_down: function (i, n) {
        if (2 != i.button || void 0 === i.button) {
          ...
          if (e.isTaskExists(s) && (o = e.getTask(s)), !e.isReadonly(o) && !this.drag.mode) {
            ...
            if (!l || !this._get_drag_mode(l)) return n.parentNode ? this.on_mouse_down(i, n.parentNode) : void 0;
            var d = this._get_drag_mode(l);
            if (d)
              if (d.mode && d.mode != r.drag_mode.ignore && r["drag_" + d.mode]) {
                ...
                if (e.isSummaryTask(o) && d.mode != r.drag_mode.progress) return void this.clear_drag_state();
                d.id = s;
      ...
      on_mouse_up: function (i) {
        ...
        if (n.mode && n.id) {
          var r = t.$getConfig(),
            a = e.getTask(n.id);
          if (r.work_time && r.correct_work_time && this._fix_working_times(a, n), this._fix_dnd_scale_time(a, n), e._init_task_timing(a), this._fireEvent("before_finish", n.mode, [n.id, n.mode, e.copy(n.obj), i])) {
            var s = n.id;
            e._init_task_timing(a), this.clear_drag_state(), e.updateTask(a.id), this._fireEvent("after_finish", n.mode, [s, n.mode, i])
          } else this.clear_drag_state(), n.obj._dhx_changed = !1, e.mixin(a, n.obj, !0), e.refreshTask(a.id)
        }
        this.clear_drag_state()
      },
      _get_drag_mode: function (e) {
        ...
        switch (a) {
          ...
          case "gantt_task_drag":
            s.mode = n.resize, r[1] && -1 !== r[1].indexOf("left", r[1].length - "left".length) ? s.left = !0 : s.left = !1;
            break;
      ...
      _start_dnd: function (i) {
        ...
        var r = t.$getConfig(),
          a = n.id;
        r["drag_" + n.mode] && e.callEvent("onBeforeDrag", [a, n.mode, i]) && this._fireEvent("before_start", n.mode, [a, n.mode, i]) ? (delete n.start_drag, e.callEvent("onTaskDragStart", [])) : this.clear_drag_state()
      },
  ...
  var n = i(1),
    r = function (t, e) {
      ...
      function s(t, i, n) {
        ...
        return i || (a.x = r.xEnd), a.y += e.config.row_height / 2, n = n || 0, a.x += (i ? -1 : 1) * n, a
      }
      ...
      function o(t, i) {
        ...
        if (r.xEnd = r.x + r.width, r.yEnd = r.y + r.height, e.getTaskType(t.type) == e.config.types.milestone) {
          var a = e.getTaskHeight(),
            s = Math.sqrt(2 * a * a);
          n.x -= s / 2, n.xEnd += s / 2, n.width = n.xEnd - n.x
        }
        return r
      }
      ...
      function g() {
        return w._direction || (w._direction = document.createElement("div"), t.$task_links.appendChild(w._direction)), w._direction
      }

      function f() {
        w._direction && (w._direction.parentNode && w._direction.parentNode.removeChild(w._direction), w._direction = null)
      }
      var p, v, m, k, y, b = e.$services,
        $ = b.getService("state"),
        x = b.getService("dnd");
      $.registerProvider("linksDnD", a);
      var w = new x(t.$task_bars, {
        sensitivity: 0,
        updates_per_second: 60
      });
      w.attachEvent("onBeforeDragStart", e.bind(function (t, a) {
        var o = a.target || a.srcElement;
        if (c(), e.getState().drag_id) return !1;
        if (n.locateClassName(o, "gantt_link_point")) {
          n.locateClassName(o, "task_left") && (y = !0);
          var l = e.locate(a);
          k = l;
          var d = e.getTask(l);
          if (e.isReadonly(d)) return c(), !1;
          var h = 0;
          return e.getTaskType(d.type) == e.config.types.milestone && (h = (r() - i()) / 2), this._dir_start = s(d, !!y, h), !0
        }
        return !1
      }, this)), w.attachEvent("onAfterDragStart", e.bind(function (t, i) {
        e.config.touch && e.refreshData(), l(w.config.marker)
      }, this)), w.attachEvent("onDragMove", e.bind(function (i, r) {
        var a = w.config,
          o = w.getPosition(r);
        d(a.marker, o);
        var c = !!n.locateClassName(r, "gantt_link_control"),
          ...
          f = e.locate(r),
          k = !0;
        if (c && (k = !n.locateClassName(r, "task_right"), c = !!f), v = f, p = c, m = k, c) {
          var y = e.getTask(f),
            b = n.locateClassName(r, "gantt_link_control"),
            $ = 0;
          b && ($ = Math.floor(b.offsetWidth / 2)), this._dir_end = s(y, !!m, $)
        } else this._dir_end = n.getRelativeEventPosition(r, t.$task_data);
        var x = !(_ == c && u == f && g == k);
        return x && (u && e.refreshTask(u, !1), f && e.refreshTask(f, !1)), x && l(a.marker), h(this._dir_start.x, this._dir_start.y, this._dir_end.x, this._dir_end.y), !0
      }, this)), w.attachEvent("onDragEnd", e.bind(function () {
        var t = a();
      ...
      return {
        ...
        _legacyGridResizerClass: function (t) {
          for (var e = t.getCellsByType("resizer"), i = 0; i < e.length; i++) {
            var n = e[i],
              r = n.$parent.getPrevSibling(n.$id);
            r && r.$config && "grid" === r.$config.id && (n.$config.css = (n.$config.css ? n.$config.css + " " : "") + "gantt_grid_resize_wrap")
          }
        },
        onCreated: function (e) {
          ...
          this._legacyGridResizerClass(e), e.attachEvent("onBeforeResize", function () {
            ...
            e.$config.hidden = e.$parent.$config.hidden = !t.config.show_chart;
            var n = t.$ui.getView("grid"),
              r = t.config.show_grid;
            if (i) {
              var a = n._getColsTotalWidth();
              !1 !== a && (t.config.grid_width = a), r = r && !!t.config.grid_width, t.config.show_grid = r
            }
            n.$config.hidden = n.$parent.$config.hidden = !r, n.$config.hidden || (n.$config.width = t.config.grid_width - 1, i ? n.$parent.$config.width = t.config.grid_width : n.$parent._setContentSize(n.$config.width, n.$config.height)), i = !1
          ...
          n && n.attachEvent("onScroll", function (e, i, n) {
            ...
            n && !t.$scroll_ver && (t.$scroll_ver = n.$scroll_ver), r && !t.$scroll_hor && (t.$scroll_hor = r.$scroll_hor)
          })
        },
        onInitialized: function (e) {
          var i = t.$ui.getView("grid");
          if (i.$parent && i.$parent.$parent && i.$parent.$parent._xLayout) {
            var n = i.$parent.$parent,
              r = n.getNextSibling(i.$parent.$id);
            if (r && "resizer" == r.$name) {
              var a;
              r.attachEvent("onResizeStart", function (e, i) {
                var n = t.$ui.getView("grid"),
                  r = n ? n.$parent : null;
                if (r) {
                  for (var s = 0, o = t.getGridColumns(), l = 0; l < o.length; l++) s += o[l].min_width ? o[l].min_width : t.config.min_grid_column_width;
                  r.$config.minWidth = s
                }
                return a = e, t.callEvent("onGridResizeStart", [e])
              }), r.attachEvent("onResize", function (e, i) {
                return t.callEvent("onGridResize", [a, e])
              }), r.attachEvent("onResizeEnd", function (e, i, n, r) {
                var a = t.$ui.getView("grid"),
                  s = a ? a.$parent : null;
                s && (s.$config.minWidth = void 0);
                var o = t.callEvent("onGridResizeEnd", [e, n]);
                return o && (t.config.grid_width = n), o
              })
            }
          }
        },
  ...
  function n(t) {
    ...
    function l(e) {
      ...
      return (e.duration || 0 === e.duration) && (e.duration = i = 1 * e.duration), i && (e.start_date && !e.end_date ? e.end_date = this.calculateEndDate(e) : !e.start_date && e.end_date && (e.start_date = this.calculateEndDate({
        ...
        duration: -e.duration,
        task: e
      }))), this._isAllowedUnscheduledTask(e) && this._set_default_task_timing(e), this._init_task_timing(e), e.start_date && e.end_date && this.correctTaskWorkTime(e), e.$source = [], e.$target = [], void 0 === e.parent && this.setParent(e, this.config.root_id), this.defined(e.$open) || (e.$open = this.defined(e.open) ? e.open : this.config.open_tree_initially), e.$level = this.calculateTaskLevel(e), e
    }
    ...
    u.attachEvent("onBeforeRefreshAll", function () {
      t.callEvent("onBeforeDataRender", []), h = t.getScrollState();
      for (var e = u.getVisibleItems(), i = 0; i < e.length; i++) {
        var n = e[i];
        n.$index = i, t.resetProjectDates(n)
      }
    }), u.attachEvent("onAfterRefreshAll", function () {
      (h.x || h.y) && t.scrollTo(h.x, h.y), t.callEvent("onDataRender", [])
      ...
      var r = t.getTask(e);
      if (this.getNext(e)) r.$drop_target = this.getNext(e);
      else {
        var a = this.getPrev(e);
        a && (a.id == this.getParent(e) ? r.$drop_target = i : r.$drop_target = "next:" + a)
      }
      return !0
    }), u.attachEvent("onStoreUpdated", function (e, i, n) {
      if ("delete" == n && t._update_flags(e, null), t.config.fit_tasks && "paint" !== n) {
        var r = t.getState();
        s(t);
        var a = t.getState();
      ...
      i(e)
    }), _.attachEvent("onIdChange", function (n, r) {
      i(t.mixin({
        id: n
      ...
      return {
        createDatastore: function (t) {
          ...
          if (t.name) {
            ...
            var n = this.$services.getService("datastores");
            n || (n = [], this.$services.setService("datastores", function () {
              return n
            })), n.push(t.name), c.bindDataStore(t.name, this)
          }
          return i
        },
        ...
        refreshData: function () {
          for (var t = n.call(this), e = 0; e < t.length; e++) t[e].refresh()
        },
        ...
        refreshTask: function (t, e) {
          ...
          if (i && this.isTaskVisible(t)) {
            if (this.$data.tasksStore.refresh(t), void 0 !== e && !e) return;
        ...
        sort: function (t, e, i, n) {
          ...
          var a = "string" == typeof t ? function (e, i) {
          ...
          if (o) {
            for (var l = [], d = o.length - 1; d >= 0; d--) l[d] = this.$data.tasksStore.getItem(o[d]);
            l.sort(a);
    ...
    r = function () {
      return {
        ...
        setParent: function (t, e) {
          return this.$data.tasksStore.setParent(t, e)
        },
        getSiblings: function (t) {
          return this.$data.tasksStore.getChildren(t)
        },
        ...
        open: function (t) {
          this._set_item_state(t, !0), this.callEvent("onTaskOpened", [t])
        },
        close: function (t) {
          this._set_item_state(t, !1), this.callEvent("onTaskClosed", [t])
        },
        _set_item_state: function (t, e) {
          this.isTaskExists(t) && (this.getTask(t).$open = !!e, this._refresh_on_toggle_element(t))
        },
        _refresh_on_toggle_element: function (t) {
          this.render()
        },
  ...
  var n = i(16),
    ...
    s = i(15),
    o = function (t) {
      return this._branches = {}, this.pull = {}, this.$initItem = t.initItem, this.$parentProperty = t.parentProperty || "parent", this.$rootId = t.rootId || 0, this.visibleOrder = n.$create(), this.fullOrder = n.$create(), this._searchVisibleOrder = {}, this._skip_refresh = !1, this._filterRule = null, a(this), this.attachEvent("onFilterItem", function (t, e) {
        var i = !0;
  ...
  o.prototype = r.mixin({
    _buildTree: function (t) {
      for (var e = null, i = 0, n = t.length; i < n; i++) e = t[i], this.setParent(e, this.getParent(e) || this.$rootId);
      for (var i = 0, n = t.length; i < n; i++) e = t[i], this._add_branch(e), e.$level = this.calculateItemLevel(e)
    },
    parse: function (t) {
      this.callEvent("onBeforeParse", [t]);
      var e = this._parseInner(t);
    ...
    _addItemInner: function (t, e) {
      ...
      r.defined(i) || (i = this.$rootId, this.setParent(t, i));
      var n = this.getIndexById(i),
        a = n + Math.min(Math.max(e, 0), this.visibleOrder.length);
      s.prototype._addItemInner.call(this, t, a), this.setParent(t, i), t.hasOwnProperty("$rendered_parent") && this._move_branch(t, t.$rendered_parent), this._add_branch(t, e)
    },
    _changeIdInner: function (t, e) {
    ...
    _removeItemInner: function (t) {
      ...
      for (var i = 0; i < e.length; i++) this._move_branch(e[i], this.getParent(e[i]), null), s.prototype._removeItemInner.call(this, e[i].id), this._move_branch(e[i], this.getParent(e[i].id), null)
    },
    move: function (t, e, i) {
      var n = arguments[3];
      if (n) {
    ...
    setParent: function (t, e) {
      t.hasOwnProperty("$rendered_parent") ? this._move_branch(t, t.$rendered_parent, e) : this._move_branch(t, t[this.$parentProperty], e), t[this.$parentProperty] = e
    },
    ...
    _add_branch: function (t, e) {
      var i = this.getParent(t);
      this.hasChild(i) || (this._branches[i] = n.$create());
      for (var r = this.getChildren(i), a = !1, s = 0, o = r.length; s < o; s++)
        if (r[s] == t.id) {
          a = !0;
          break
        }
      a || (1 * e == e ? r.splice(e, 0, t.id) : r.push(t.id), t.$rendered_parent = i)
    },
    _move_branch: function (t, e, i) {
      this._replace_branch_child(e, t.id), this.exists(i) || i == this.$rootId ? this._add_branch(t) : delete this._branches[t.id], t.$level = this.calculateItemLevel(t), this.eachItem(function (t) {
    ...
    var i = e.getDatastore(t),
      n = {
        ...
        renderItems: function (t) {
          ...
          for (var r = i.getVisibleItems(), n = 0; n < e.length; n++) e[n].render_items(r)
        }
      };
    i.attachEvent("onStoreUpdated", function (r, a, s) {
      var o = e.$services.getService("layers").getDataRender(t);
      o && (r && "move" != s && "delete" != s ? (i.callEvent("onBeforeRefreshItem", [r]), n.renderItem(r, o), i.callEvent("onAfterRefreshItem", [r])) : (i.callEvent("onBeforeRefreshAll", []), n.renderItems(o), i.callEvent("onAfterRefreshAll", [])))
    })
  };
  t.exports = {
    bindDataStore: i
  ...
  function n(t) {
    t.dataProcessor = i(60), t._dp_init = function (e) {
      function i(i) {
      ...
      e.setTransactionMode("POST", !0), e.serverProcessor += (-1 != e.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true", e._serverProcessor = e.serverProcessor, e.$gantt = this, e.styles = {
        ...
        error: "gantt_error",
        clear: ""
      }, e._methods = ["_row_style", "setCellTextStyle", "_change_id", "_delete_task"], e.setGanttMode = function (t) {
        var i = e.modes || {};
        ...
        e.setGanttMode("tasks"), !i(t) && (e.setUpdated(t, !0, "deleted"), "off" == e.updateMode || e._tSend || e.sendAllData())
        ...
        e.setGanttMode("links"), !i(t) && e.setUpdated(t, !0, "deleted")
      }), this.attachEvent("onRowDragEnd", function (e, i) {
        t._sendTaskOrder(e, t.getTask(e))
      });
      var s = null,
        o = null;
      this.attachEvent("onTaskIdChange", function (i, r) {
        if (e._waitMode) {
          var a = t.getChildren(r);
          if (a.length) {
            s = s || {};
            for (var l = 0; l < a.length; l++) {
              var d = this.getTask(a[l]);
              s[d.id] = d
            }
          }
          var c = this.getTask(r),
            h = n(c);
          if (h.length) {
            o = o || {};
            for (var l = 0; l < h.length; l++) {
              var u = this.getLink(h[l]);
              o[u.id] = u
            }
          }
        }
      }), e.attachEvent("onAfterUpdateFinish", function () {
        (s || o) && (t.batchUpdate(function () {
          for (var e in s) t.updateTask(s[e].id);
          for (var e in o) t.updateLink(o[e].id);
          s = null, o = null
        }), s ? t._dp.setGanttMode("tasks") : t._dp.setGanttMode("links"))
  ...
  t.exports = function (t) {
    for (var e = [i(62), i(63), i(64), i(65), i(66)], n = 0; n < e.length; n++) e[n] && e[n](t)
  }
}, function (t, e, i) {
  var n = i(1);
  t.exports = function (t) {
    function e() {
      ...
      return g = e && !i && !n, !(!t.getState().drag_mode && !e || i)
    }

    function i(e) {
      if (f && (clearTimeout(f), f = null), e) {
        var i = t.config.autoscroll_speed;
        i && i < 10 && (i = 10), f = setTimeout(function () {
          _ = setInterval(s, i || u), p = n.getNodePosition(t.$task)
        }, t.config.autoscroll_delay || h)
      }
    }

    function r(t) {
      t ? (i(!0), v.started || (v.x = m.x, v.y = m.y, v.started = !0)) : (_ && (clearInterval(_), _ = null), i(!1), v.started = !1)
    }

    function a(i) {
      var n = e();
      if (!_ && !f || n || r(!1), !t.config.autoscroll || !n) return !1;
      m = {
        x: i.clientX,
        y: i.clientY
      }, !_ && n && r(!0)
    ...
    function s() {
      if (!e()) return r(!1), !1;
      var i = n.getNodePosition(t.$task),
        a = m.x - i.x,
        s = m.y - i.y,
        d = g ? 0 : o(a, i.width, v.x - i.x),
        h = o(s, i.height, v.y - i.y),
        u = t.getScrollState(),
        _ = u.y,
        f = u.inner_height,
        p = u.height,
        ...
        y = u.inner_width,
        b = u.width;
      h && !f ? h = 0 : h < 0 && !_ ? h = 0 : h > 0 && _ + f >= p + 2 && (h = 0), d && !y ? d = 0 : d < 0 && !k ? d = 0 : d > 0 && k + y >= b && (d = 0);
      var $ = t.config.autoscroll_step;
      $ && $ < 2 && ($ = 2), d *= $ || c, h *= $ || c, (d || h) && l(d, h)
    }

    function o(t, e, i) {
      return t - d < 0 && t < i ? -1 : t > e - d && t > i ? 1 : 0
    }
    ...
    var d = 50,
      ...
      m = {};
    t.attachEvent("onGanttReady", function () {
      t.eventRemove(document.body, "mousemove", a), t.event(document.body, "mousemove", a)
    })
  }
}, function (t, e) {
  function i() {
    function t(t, e) {
      e = "function" == typeof e ? e : function () {}, a[t] || (a[t] = this[t], this[t] = e)
    }

    function e(t) {
      a[t] && (this[t] = a[t], a[t] = null)
    }
    ...
    var a = {},
      s = !1;
    return function (t, e) {
      if (s) return void r(t);
      var a, o = this._dp && "off" != this._dp.updateMode;
      o && (a = this._dp.updateMode, this._dp.setUpdateMode("off"));
      var l = {},
        d = {
          render: !0,
          refreshData: !0,
      ...
      i.call(this, d), s = !0, this.callEvent("onBeforeBatchUpdate", []), r(t), this.callEvent("onAfterBatchUpdate", []), n.call(this);
      for (var c in l) this.resetProjectDates(l[c]);
      s = !1, e || this.render(), o && (this._dp.setUpdateMode(a), this._dp.setGanttMode("tasks"), this._dp.sendData(), this._dp.setGanttMode("links"), this._dp.sendData())
    }
  }
  t.exports = function (t) {
    t.batchUpdate = i()
  ...
  n.prototype = {
    ...
    _getClosestWorkTime: function (t) {
      ...
      var e = t.unit,
        ...
        o = "any" == t.dir || !t.dir,
        l = 1;
      for ("past" == t.dir && (l = -1); !this._isWorkTime(i, e);) {
        o && (i = a ? n : r, l *= -1);
        var d = i.getTimezoneOffset();
        if (i = this.$gantt.date.add(i, l, e), i = this.$gantt._correct_dst_change(i, d, l, e), this.$gantt.date[e + "_start"] && (i = this.$gantt.date[e + "_start"](i)), o && (a ? n = i : r = i), a = !a, ++s > 3e3) return this.$gantt.assert(!1, "Invalid working time check"), !1
      }
  ...
  t.exports = function (t) {
    t.isUnscheduledTask = function (t) {
      ...
      if (!e) return [];
      for (var i = e.$source.concat(e.$target), n = this.getChildren(e.id), r = 0; r < n.length; r++) i = i.concat(this._getChildLinks(n[r]));
      for (var a = {}, r = 0; r < i.length; r++) a[i[r]] = !0;
      i = [];
      for (var r in a) this.isLinkExists(r) && i.push(r);
      return i
    }, t._getTaskTree = function (t) {
      var e = this.getTask(t);
      if (!e) return [];
      for (var i = [], n = this.getChildren(e.id), r = 0; r < n.length; r++) i.push(n[r]), i = i.concat(this._getTaskTree(n[r]));
      return i
    }, t._deleteRelatedLinks = function (t, e) {
      var i = this._dp && !e && this.config.cascade_delete,
        n = "",
        r = !!i && "off" != this._dp.updateMode;
      i && (n = this._dp.updateMode, this._dp.setUpdateMode("off"));
      for (var a = 0; a < t.length; a++) i && (this._dp.setGanttMode("links"), this._dp.setUpdated(t[a], !0, "deleted"));
      this.$data.linksStore.silent(function () {
        for (var e = 0; e < t.length; e++) this.$data.linksStore.removeItem(t[e])
      }, this), i && (this._dp.setUpdateMode(n), r && this._dp.sendAllData())
    }, t._deleteRelatedTasks = function (t, e) {
      var i = this._dp && !e && this.config.cascade_delete,
        n = "";
      i && (n = this._dp.updateMode, this._dp.setGanttMode("tasks"), this._dp.setUpdateMode("off"));
      for (var r = this._getTaskTree(t), a = 0; a < r.length; a++) {
        var s = r[a];
        this.$data.tasksStore.silent(function () {
          this.$data.tasksStore.removeItem(s)
        }), i && this._dp.setUpdated(s, !0, "deleted")
      }
      i && this._dp.setUpdateMode(n)
    }, t._update_flags = function (t, e) {
      void 0 === t ? (this._lightbox_id = this._selected_task = null, this._tasks_dnd && this._tasks_dnd.drag && (this._tasks_dnd.drag.id = null)) : (this._lightbox_id == t && (this._lightbox_id = e), this._selected_task == t && (this._selected_task = e), this._tasks_dnd && this._tasks_dnd.drag && this._tasks_dnd.drag.id == t && (this._tasks_dnd.drag.id = e))
      ...
      n.isDate(e) && (e = {
        date: e,
        unit: t.getScale().unit,
        step: t.getScale().step
      });
      var i, r, a, s = e.date,
        o = e.step,
        l = e.unit;
      if (l == t.getScale().unit && o == t.getScale().step && +s >= +t._min_date && +s <= +t._max_date) a = Math.floor(t.columnIndexByDate(s)), t.getScale().trace_x[a] || (a -= 1), r = new Date(t.getScale().trace_x[a]), i = new Date(r), i = t.getScale().trace_x[a + 1] ? new Date(t.getScale().trace_x[a + 1]) : t.date.add(r, o, l);
      else {
        for (a = Math.floor(t.columnIndexByDate(s)), i = t.date[l + "_start"](new Date(this._min_date)), t.getScale().trace_x[a] && (i = t.date[l + "_start"](t.getScale().trace_x[a])); + i < +s;) {
          i = t.date[l + "_start"](t.date.add(i, o, l));
          var d = i.getTimezoneOffset();
          i = t._correct_dst_change(i, d, i, l), t.date[l + "_start"] && (i = t.date[l + "_start"](i))
        }
        r = t.date.add(i, -1 * o, l)
      }
      return e.dir && "future" == e.dir ? i : e.dir && "past" == e.dir ? r : Math.abs(s - r) < Math.abs(i - s) ? r : i
      ...
      var o = this.getChildren(i);
      if (o) {
        for (var l = [], d = o.length - 1; d >= 0; d--) l[d] = this.getTask(o[d]);
        l.sort(a);
        for (var d = 0; d < l.length; d++) o[d] = l[d].id, this.sort(t, e, o[d], !0)
      }
      r && this.render()
  ...
  t.exports = function (t) {
    ...
    t._lightbox_methods = {}, t._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>", t.$services.getService("state").registerProvider("lightbox", function () {
      ...
      t.lightbox_events = {}, t.lightbox_events.gantt_save_btn = function (e) {
        ...
        if (n.getAttribute("dhx_button")) t.callEvent("onLightboxButton", [n.className, n, i]);
        else {
          var r, a, s, o = e.getClassName(n);
          if (-1 != o.indexOf("gantt_custom_button"))
            if (-1 != o.indexOf("gantt_custom_button_"))
              for (r = n.parentNode.getAttribute("index"), s = n; s && -1 == e.getClassName(s).indexOf("gantt_cal_lsection");) s = s.parentNode;
            else r = n.getAttribute("index"), s = n.parentNode, n = n.firstChild;
          var l = t._get_typed_lightbox_config();
          r && (r *= 1, a = t.form_blocks[l[1 * r].type], a.button_click(r, n, s, s.nextSibling))
        }
      }, this.event(t.getLightbox(), "click", function (i) {
        i = i || window.event;
        var n = i.target ? i.target : i.srcElement,
          r = e.getClassName(n);
      ...
      getTimePicker: function (e, i) {
        ...
        if (!n) {
          var n = ["%d", "%m", "%Y"];
          t._get_line(t.getScale().unit) < t._get_line("day") && n.push("%H:%i")
        }
        e._time_format_order = {
          size: 0
        };
        var r = this.config,
          a = this.date.date_part(new Date(t._min_date.valueOf())),
          s = 1440,
          o = 0;
        t.config.limit_time_select && (s = 60 * r.last_hour + 1, o = 60 * r.first_hour, a.setHours(r.first_hour));
        for (var l = "", d = 0; d < n.length; d++) {
          ...
          switch (c) {
            case "%Y":
              ...
              var u, _, g, f;
              e.year_range && (isNaN(e.year_range) ? e.year_range.push && (g = e.year_range[0], f = e.year_range[1]) : u = e.year_range), u = u || 10, _ = _ || Math.floor(u / 2), g = g || a.getFullYear() - _, f = f || g + u;
              for (var p = g; p < f; p++) h += "<option value='" + p + "'>" + p + "</option>";
              break;
            case "%m":
              e._time_format_order[1] = d, e._time_format_order.size++;
              for (var p = 0; p < 12; p++) h += "<option value='" + p + "'>" + this.locale.date.month_full[p] + "</option>";
              break;
            case "%d":
              e._time_format_order[0] = d, e._time_format_order.size++;
              for (var p = 1; p < 32; p++) h += "<option value='" + p + "'>" + p + "</option>";
              break;
            case "%H:%i":
              e._time_format_order[3] = d, e._time_format_order.size++;
              var p = o,
                v = a.getDate();
              for (e._time_values = []; p < s;) h += "<option value='" + p + "'>" + this.templates.time_picker(a) + "</option>", e._time_values.push(p), a.setTime(a.valueOf() + 60 * this._get_timepicker_step() * 1e3), p = 24 * (a.getDate() != v ? 1 : 0) * 60 + 60 * a.getHours() + a.getMinutes()
          }
          if (h) {
            var m = t._waiAria.lightboxSelectAttrString(c);
            l += "<select " + (e.readonly ? "disabled='disabled'" : "") + (i ? " style='display:none' " : "") + m + ">" + h + "</select>"
          }
        }
        return l
      },
  ...
  function n(t, e) {
    ...
    l[1] && void 0 === l[1].width && (l[1].width = o._second_column_width), l[2] && void 0 === l[2].width && (l[2].width = o._third_column_width), o.config.task_height && (e.config.task_height = o.config.task_height || "full"), o._lightbox_template && (e._lightbox_template = o._lightbox_template), o._redefine_lightbox_buttons && (e.config.buttons_right = o._redefine_lightbox_buttons.buttons_right, e.config.buttons_left = o._redefine_lightbox_buttons.buttons_left), e.resetLightbox()
  }
  t.exports = function (t) {
  ...
  t.exports = function (t) {
    var e = i(17);
    t.assert = i(95)(t), t.init = function (e, i, r) {
      ...
      var i = this._getVerticalScrollbar(),
        n = this._getHorizontalScrollbar(),
        r = i.getScrollState(),
        a = n.getScrollState();
      1 * t == t && n.scroll(t), 1 * e == e && i.scroll(e);
      var s = i.getScrollState(),
        o = n.getScrollState();
      this.callEvent("onGanttScroll", [a.position, r.position, o.position, s.position])
    ...
    }, t.setSizes = t.render, t._scroll_state = function () {
      var e = {
          x: !1,
          y: !1,
          x_pos: 0,
        ...
        i = t._getVerticalScrollbar(),
        n = t._getHorizontalScrollbar();
      if (n) {
        var r = n.getScrollState();
        r.visible && (e.x = r.size, e.x_inner = r.scrollSize), e.x_pos = r.position || 0
      }
      if (i) {
        var a = i.getScrollState();
        a.visible && (e.y = a.size, e.y_inner = a.scrollSize), e.y_pos = a.position || 0
      }
      return e
    }, t.locate = function (t) {
    ...
    }, t._correct_dst_change = function (e, i, n, r) {
      var a = t._get_line(r) * n;
      if (a > 3600 && a < 86400) {
  ...
  t.exports = function (t) {
    ...
    for (var i = ["message", "alert", "confirm", "modalbox", "uid", "copy", "mixin", "defined", "bind", "assert"], n = 0; n < i.length; n++) window.dhtmlx[i[n]] || (dhtmlx[i[n]] = function (i) {
      return function () {
