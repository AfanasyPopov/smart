...
var createMouseHandler = (function(domHelpers) {
	return function (gantt) {
		...
		function addEventTarget(event, className, handler, root) {
			...
			eventHandlers[event][className]=[{ //Afanasy / was a push elements as element array { //Afanasy / was a push elements as element array .push({handler: handler,root: root})
				handler: handler,
				root: root
			}];
		}
