...
!function(t) {
    ...
    o.prototype = r.mixin({
        ...
        _updateOrder: function(t) {
            t && s.prototype._updateOrder.call(this, t), this.fullOrder = n.$create(), this._traverseBranches(function(t) {
        ...
        _removeItemInner: function(t) {
            ...
            for (var i = 0; i < e.length; i++)
                this._move_branch(e[i], this.getParent(e[i]), null), s.prototype._removeItemInner.call(this, e[i].id), this._move_branch(e[i], this.getParent(e[i].id), null)
        },
        move: function(t, e, i) {
            var n = arguments[3];
            if (n) {
    ...
    n.plugin = function(t) {
        ...
        for (var t = i(27)(), e = 0; e < n._ganttPlugin.length; e++)
            n._ganttPlugin[e](t);
        return t._internal_id = n._seed++, n.$syncFactory && n.$syncFactory(t), i(111)(t), t
    }, t.exports = n
}, function(t, e, i) {
    function n() {
        this.version = "5.1.0", this.templates = {}, this.keys = {
            edit_save: 13,
            edit_cancel: 27
        }
    }
    t.exports = function() {
        ...
        var d = i(37).init(t);
        return t.$ui = d.factory, t.$ui.layers = d.render, t.$mouseEvents = d.mouseEvents, t.$services.setService("mouseEvents", function() {
            return t.$mouseEvents
        }), t.mixin(t, d.layersApi), i(63)(t), t.$services.setService("layers", function() {
            return d.layersService
        }), i(64)(t), i(70)(t), i(73)(t), i(80)(t), i(81)(t), i(83)(t), i(84)(t), i(85)(t), i(86)(t), i(93)(t), i(94)(t), i(95)(t), i(96)(t), i(97)(t), i(98)(t), i(99)(t), i(100)(t), i(101)(t), i(102)(t), i(103)(t), i(104)(t), i(105)(t), i(106)(t), i(107)(t), i(108)(t), i(110)(t), t
    }
}, function(t, e) {
    t.exports = function(t) {
        t.$inject = function(t) {
                    ...
                    var o = {
                        ...
                        _add: function(t) {
                            if (t && (t.id = t.id || a.uid(), this.tempCollection.push(t)), this.container())
                                for (var i = this.container(), n = this.tempCollection, s = 0; s < n.length; s++) {
                                    t = n[s];
                                    var o = t.container,
                                        l = t.id,
                                        d = t.topmost;
                                    if (!o.parentNode)
                                        if (d)
                                            ...
                                            var c = r ? r() : i.firstChild;
                                            c ? i.insertBefore(o, c) : i.appendChild(o)
                                        }
                        ...
                        addLayer: function(t) {
                            return t && ("function" == typeof t && (t = {
                                renderer: t
                            }), void 0 === t.filter ? t.filter = n(s || []) : t.filter instanceof Array && (t.filter.push(s), t.filter = n(t.filter)), t.container || (t.container = document.createElement("div"))), this._add(t), t ? t.id : void 0
                        },
    ...
    var n = i(3),
        ...
        o = function(t) {
            ...
            return n(e, t), e.prototype.init = function() {
                ...
                this.$config.prev && (this._behind = this.$factory.getView(this.$config.prev)), this.$config.next && (this._front = this.$factory.getView(this.$config.next));
        ...
        l = function(t) {
            ...
            return n(e, t), e.prototype.init = function(t) {
                ...
                for (var t, e = 0, i = 0, n = this._isHorizontal(), r = this._getLinkedViews(), a = n ? "scrollWidth" : "scrollHeight", s = n ? "contentX" : "contentY", o = n ? "x" : "y", l = this._getScrollOffset(), d = 0; d < r.length; d++)
                    if ((t = r[d]) && t.$content && t.$content.getSize) {
                        var c,
                            h = t.$content.getSize();
    ...
    function n(t) {
        function e(e, i) {
            ...
            var $ = document.createElement("div");
            return $.className = "gantt_row" + v, $.style.height = a.row_height + "px", $.style.lineHeight = a.row_height + "px", a.smart_rendering && ($.style.position = "absolute", $.style.left = "0px", $.style.top = i.getItemTop(e.id) + "px"), i.$config.item_attribute && $.setAttribute(i.$config.item_attribute, e.id), t._waiAria.taskRowAttr(e, $), $.innerHTML = d.join(""), $
        }
        return e
    }
    var r = i(4);
        ...
        if (e.$config.bind && t.getDatastore(e.$config.bind)) {
            ...
            t.defined(e.$getConfig().dnd_sensitivity) && (s.config.sensitivity = e.$getConfig().dnd_sensitivity), s.attachEvent("onBeforeDragStart", t.bind(function(r, a) {
                ...
                if (d.exists(u) || (u = s.lastTaskOfLevel(l.order_branch_free ? c.$level : 0)) == s.config.id && (u = null), d.exists(u)) {
                    ...
                    for (var g = d.getIndexById(_.id), v = d.getIdByIndex(g - 1), m = d.getItem(v), k = 1; (!m || m.id == _.id) && g - k >= 0;)
        ...
        o = function() {
            return function(t) {
                ...
                return {
                    onCreated: function(e) {
                        var s = e.$config;
                        s.bind = n.defined(s.bind) ? s.bind : "task", s.bindLinks = n.defined(s.bindLinks) ? s.bindLinks : "link", e._linksDnD = a.createLinkDND(), e._tasksDnD = r.createTaskDND(), e._tasksDnD.extend(e), "timeline" == e.$config.id && this.extendGantt(e), this._mouseDelegates = i(9)(t)
                    },
                    onInitialized: function(e) {
            ...
            return {
                ...
                onCreated: function(e) {
                    ...
                    this._legacyGridResizerClass(e), e.attachEvent("onBeforeResize", function() {
                        ...
                        e && (e.$config.hidden = e.$parent.$config.hidden = !t.config.show_chart);
                        var n = t.$ui.getView("grid");
                        if (n) {
                            var r = t.config.show_grid;
                            if (i) {
                                var a = n._getColsTotalWidth();
                                !1 !== a && (t.config.grid_width = a), r = r && !!t.config.grid_width, t.config.show_grid = r
                            }
                            if (n.$config.hidden = n.$parent.$config.hidden = !r, !n.$config.hidden) {
                                var s = n._getGridWidthLimits();
                                s[0] && t.config.grid_width < s[0] && (t.config.grid_width = s[0]), s[1] && t.config.grid_width > s[1] && (t.config.grid_width = s[1]), n.$config.width = t.config.grid_width - 1, i ? (n.$parent.$config.width = t.config.grid_width, n.$parent.$config.group && t.$layout._syncCellSizes(n.$parent.$config.group, n.$parent.$config.width)) : n.$parent._setContentSize(n.$config.width, n.$config.height)
                            }
                            i = !1
                        }
                ...
                onInitialized: function(e) {
                    ...
                    if (i && i.$parent && i.$parent.$parent && i.$parent.$parent._xLayout) {
                        var n = i.$parent.$parent,
                            r = n.getNextSibling(i.$parent.$id),
                            a = !0;
                        if (r && "resizer" == r.$name || (r = n.getPrevSibling(i.$parent.$id), a = !1), r && "resizer" == r.$name) {
                            var s;
                            r.attachEvent("onResizeStart", function(e, i) {
                                ...
                                if (r) {
                                    ...
                                    n.$config.scrollable || (r.$config.minWidth = o[0]), r.$config.maxWidth = o[1]
                                }
                                return s = a ? e : i, t.callEvent("onGridResizeStart", [s])
                            }), r.attachEvent("onResize", function(e, i) {
                                var n = a ? e : i;
                                return t.callEvent("onGridResize", [s, n])
    ...
    function n(t) {
        ...
        u.attachEvent("onBeforeRefreshAll", function() {
            ...
            var r = t.getTask(e);
            return null !== this.getNextSibling(e) ? r.$drop_target = this.getNextSibling(e) : null !== this.getPrevSibling(e) ? r.$drop_target = "next:" + this.getPrevSibling(e) : r.$drop_target = "next:null", !0
            ...
            n(e)
        }), _.attachEvent("onIdChange", function(i, r) {
            n(t.mixin({
                id: i
    ...
    var i = function(t, e) {
        ...
        r.attachEvent("onStoreUpdated", function(n, s, o) {
            if (!i(e)) {
                ...
                l && (n && "move" != o && "delete" != o ? (r.callEvent("onBeforeRefreshItem", [s.id]), a.renderItem(s.id, l), r.callEvent("onAfterRefreshItem", [s.id])) : (r.callEvent("onBeforeRefreshAll", []), a.renderItems(l), r.callEvent("onAfterRefreshAll", [])))
            }
        }), r.attachEvent("onItemOpen", function() {
            e.render()
        }), r.attachEvent("onItemClose", function() {
            e.render()
        }), r.attachEvent("onIdChange", function(a, s) {
            if (!i(e)) {
                n(e.$services.getService("layers").getDataRender(t).getLayers(), a, s, r.getItem(s))
            }
        })
    };
    t.exports = {
    ...
    t.exports = function(t) {
        for (var e = [i(74), i(75), i(76), i(77), i(78), i(79)], n = 0; n < e.length; n++)
            e[n] && e[n](t)
    }
}, function(t, e, i) {
    var n = i(1);
    t.exports = function(t) {
        ...
        function a(i) {
            var n = e();
            if (!_ && !f || n || r(!1), !t.config.autoscroll || !n)
                return !1;
            m = {
                x: i.clientX,
                y: i.clientY
    ...
    var n = i(8);
    t.exports = function(t) {
        i(82)(t), n.prototype.getGridColumns = function() {
    ...
    n.prototype = {
        ...
        _getClosestWorkTime: function(t) {
            ...
            for ("past" == t.dir && (l = -1); !this._isWorkTime(i, e);) {
                ...
                if (i = this.$gantt.date.add(i, l, e), i = this.$gantt._correct_dst_change(i, d, l, e), this.$gantt.date[e + "_start"] && (i = this.$gantt.date[e + "_start"](i)), o && (a ? n = i : r = i), a = !a, ++s > 3e3)
    ...
    t.exports = function(t) {
        t.isUnscheduledTask = function(t) {
            ...
            var i,
                ...
                l = e.unit,
                d = t.getScale();
            if (l == d.unit && o == d.step && +s >= +t._min_date && +s <= +t._max_date)
                a = Math.floor(t.columnIndexByDate(s)), t.getScale().trace_x[a] || (a -= 1, d.rtl && (a = 0)), r = new Date(t.getScale().trace_x[a]), i = t.date.add(r, o, l);
            else {
                for (a = Math.floor(t.columnIndexByDate(s)), i = t.date[l + "_start"](new Date(this._min_date)), d.trace_x[a] && (i = t.date[l + "_start"](d.trace_x[a])); +i < +s;) {
                    i = t.date[l + "_start"](t.date.add(i, o, l));
                    var c = i.getTimezoneOffset();
                    i = t._correct_dst_change(i, c, i, l), t.date[l + "_start"] && (i = t.date[l + "_start"](i))
                }
    ...
    t.exports = function(t) {
        ...
        t._lightbox_methods = {}, t._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>", t.$services.getService("state").registerProvider("lightbox", function() {
            ...
            if (this.config.round_dnd_dates) {
                var i = t.getScale(),
                    n = a.getSecondsInUnit(i.unit) * i.step / 60;
                return (n >= 1440 || !e(this)) && (n = this.config.time_step), n
            }
            ...
            getTimePicker: function(e, i) {
                ...
                if (!n) {
                    var n = ["%d", "%m", "%Y"];
                    a.getSecondsInUnit(t.getScale().unit) < a.getSecondsInUnit("day") && n.push("%H:%i")
                }
                ...
                var r = this.config,
                    ...
                    o = 1440,
                    l = 0;
                t.config.limit_time_select && (o = 60 * r.last_hour + 1, l = 60 * r.first_hour, s.setHours(r.first_hour));
                for (var d = "", c = 0; c < n.length; c++) {
                    ...
                    switch (h) {
                    case "%Y":
                        e._time_format_order[2] = c, e._time_format_order.size++;
                        var _,
                            g,
                            f,
                            p;
                        e.year_range && (isNaN(e.year_range) ? e.year_range.push && (f = e.year_range[0], p = e.year_range[1]) : _ = e.year_range), _ = _ || 10, g = g || Math.floor(_ / 2), f = f || s.getFullYear() - g, p = p || f + _;
                        for (var v = f; v < p; v++)
                            u += "<option value='" + v + "'>" + v + "</option>";
                        break;
                    case "%m":
                        e._time_format_order[1] = c, e._time_format_order.size++;
                        for (var v = 0; v < 12; v++)
                            u += "<option value='" + v + "'>" + this.locale.date.month_full[v] + "</option>";
                        break;
                    case "%d":
                        e._time_format_order[0] = c, e._time_format_order.size++;
                        for (var v = 1; v < 32; v++)
                            u += "<option value='" + v + "'>" + v + "</option>";
                        break;
                    case "%H:%i":
                        e._time_format_order[3] = c, e._time_format_order.size++;
                        var v = l,
                            m = s.getDate();
                        for (e._time_values = []; v < o;)
                            u += "<option value='" + v + "'>" + this.templates.time_picker(s) + "</option>", e._time_values.push(v), s.setTime(s.valueOf() + 60 * this._get_timepicker_step() * 1e3), v = 24 * (s.getDate() != m ? 1 : 0) * 60 + 60 * s.getHours() + s.getMinutes()
                    }
                    if (u) {
                        var k = t._waiAria.lightboxSelectAttrString(h);
                        d += "<select " + (e.readonly ? "disabled='disabled'" : "") + (i ? " style='display:none' " : "") + k + ">" + u + "</select>"
                    }
                }
                return d
            },
    ...
    t.exports = function(t) {
        var e = i(19);
        t.assert = i(109)(t), t.init = function(e, i, r) {
